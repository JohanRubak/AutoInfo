...
{
   public class Generic_PortraitTemplate : IDocument
   {
      //Starter word
      ...
      float constantHeightDI14 = 200;
      float constantHeightDI56 = 100;
            ...
            switch (contentControl.Title)
            {
               ...
               case "DeliveredInstruments1":
                  if (filesPathSorted[1].Any())
                  {
                     ...
                     scale = constantHeightDI14 / height * 100;
               ...
               case "DeliveredInstruments5":
                  ...
                  if (filesPathSorted[1].Count() >= 5)
                  {
                     ...
                     scale = constantHeightDI56 / height * 100;
